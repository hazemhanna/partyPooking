...
class SearchViewController: UIViewController ,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    @IBOutlet weak var artistTypeTextField: TextFieldDropDown!
    ...
    var artistType = ["male".localized ,"female".localized]
    ...
    override func viewDidLoad() {
        ...
        if "lang".localized == "ar" {
            ...
            artistTypeTextField.textAlignment = .right

        }else{
            partyTypeTextField.textAlignment = .left
            countryTextField.textAlignment = .left
            artistTypeTextField.textAlignment = .left
    ...
    func setUPLocalize(){
        ...
        artistTypeTextField.text = "artistType".localized
    ...
    func setupArtistDropDown() {
        artistTypeTextField.optionArray = self.artistType
        artistTypeTextField.didSelect { (selectedText, index, id) in
            self.artistTypeTextField.text = selectedText
        }
    }
